...
public class FIRBetweenDatesPanel extends JPanel {

    private JSpinner fromDateSpinner, toDateSpinner;
    private JTable table;
    private DefaultTableModel model;

    public FIRBetweenDatesPanel() {

        setLayout(new BorderLayout());
        setBackground(new Color(236,240,245));

        // ===== TITLE =====
        JLabel title = new JLabel("FIR Report Between Dates");
    ...
    private void loadReport() {
        ...
        try {
            ...
            ps.setInt(3, PoliceSession.policeStationId);  // 🔥 station wise filter
