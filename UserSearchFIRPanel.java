...
public class UserSearchFIRPanel extends JPanel {
    ...
    public UserSearchFIRPanel(int userId) {
        ...
        // ===== TITLE =====
        JLabel title = new JLabel("Search FIR");
    ...
    private void searchFIR() {
        ...
        try {
            ...
            String sql = """
                ...
                FROM fir
                WHERE user_id = ?   -- 🔥 IMPORTANT CHANGE
                AND LOWER(applicant_name) LIKE LOWER(?)
                ORDER BY fir_id DESC
            """;

            PreparedStatement ps = con.prepareStatement(sql);
            ps.setInt(1, userId); // 🔥 user filter
