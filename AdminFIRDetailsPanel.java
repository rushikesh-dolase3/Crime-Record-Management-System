...
public class AdminFIRDetailsPanel extends JPanel {

    Connection con;
    int firId;

    public AdminFIRDetailsPanel(int firId) {
        ...
        JLabel title = new JLabel("FIR Complete Details");
